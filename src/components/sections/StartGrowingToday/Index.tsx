        ...
        <div className="flex items-center justify-center gap-[60px]">
          <div className="flex flex-col w-1/2 gap-10">
            ...
            <div>
              ...
              <p className="text-base font-medium text-third">
                We provide a variety of servers to grow your users <br />
                acquisition much user-friendly and boosting up sales.
              </p>
            </div>
            <div className="flex items-center gap-5">
              <button className="bg-[#FFD15A] py-4 px-10 rounded-full text-lg font-bold text-primary  ">
                Explore More
              </button>
              <button className="flex items-center gap-[6px] text-base text-third font-semibold">
                <img src={IconsAll.message} alt="Message" />
                Schedule a Demo
              </button>
            </div>
          </div>
